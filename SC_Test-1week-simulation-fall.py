...
if __name__ == "__main__":
    ...
    hourly_pv = [
        0, 0, 0, 0, 0, 6.061134975, 6.397267385, 6.903324666, 7.357215637, 8.542894234, 7.117720963, 6.490196415, 6.60863886, 6.56429812, 6.361090348, 6.167609343, 6.041272137, 0, 0, 0, 0, 0, 0, 0
    ]
...
if __name__ == "__main__":
    ...
    # Hourly PV data spanning 168 hours
    hourly_load = [
        12.88363314, 11.11111961, 9.970685465, 8.456878426, 9.976947046, 14.44704795, 10.66489019, 8.867653703, 8.437905225, 10.7168278, 12.5181875, 11.97248991, 11.41247365, 13.23864551, 13.48786711, 12.87671792, 13.05852282, 12.7031686, 15.53633444, 15.71355342, 15.98001818, 14.31120579, 12.86749937, 12.66143291
    ]
...
if __name__ == "__main__":
    ...
    # Hourly PV data spanning 168 hours
    hourly_heat = [
        13, 23, 16, 16.5, 31.5, 20, 28, 18, 32, 22, 17, 30, 23, 23, 19, 7, 15, 30, 22, 15, 15, 21, 22, 28
    ]
...
while datetime.now() < end_time:
    ...
    def save_optimization_results(model, output_file="optimization_resultsFALL.csv"):
        """
